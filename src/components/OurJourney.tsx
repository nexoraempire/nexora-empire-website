  ...
  const milestones: JourneyMilestone[] = [
    {
      ...
      icon: Flag,
      imageUrl: '/src/assets/images/modern-office-nexora-empire-workspace-office.png',
    ...
    },
    {
      ...
      icon: Cpu,
      imageUrl: '/src/assets/images/ai-powered-web-development-foffe-lili2.webp',
    ...
    },
    {
      ...
      icon: Rocket,
      imageUrl: '/src/assets/images/global-empire.jpeg',
