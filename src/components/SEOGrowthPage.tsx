...
export const SEOGrowthPage: React.FC<SEOGrowthPageProps> = ({ setView }) => {
  ...
  const [activeMetricTab, setActiveMetricTab] = useState<'traffic' | 'keywords' | 'rankings'>('traffic');

  const seoServices: { id: string; title: string; description: React.ReactNode; icon: any }[] = [
    {
      id: 'seo-service-card-01',
      title: 'Technical SEO',
      description: <span>Optimize your website for <span className="font-semibold text-slate-800">speed, indexing, Core Web Vitals</span>, and search engine performance.</span>,
      icon: Activity,
    },
    {
      id: 'seo-service-card-02',
      title: 'Local SEO',
      description: <span>Increase visibility in local searches and <span className="font-semibold text-slate-800">Google Business Profile results</span>.</span>,
      icon: MapPin,
    },
    {
      id: 'seo-service-card-03',
      title: 'Keyword Research',
      description: <span>Identify <span className="font-semibold text-slate-800">high-value, high-intent keywords</span> that attract your ideal customers.</span>,
      icon: Search,
    },
    {
      id: 'seo-service-card-04',
      title: 'Content Strategy',
      description: <span>Create SEO-focused content that drives <span className="font-semibold text-slate-800">long-term, compounding organic traffic</span>.</span>,
      icon: FileText,
    },
    {
      id: 'seo-service-card-05',
      title: 'Website Audits',
      description: <span>Comprehensive audits to identify <span className="font-semibold text-slate-800">technical issues, crawlablity bottlenecks</span>, and growth opportunities.</span>,
      icon: FileSearch,
    },
    {
      id: 'seo-service-card-06',
      title: 'Analytics & Reporting',
      description: <span>Track rankings, traffic, conversions, and campaign performance with <span className="font-semibold text-slate-800">detailed interactive reporting</span>.</span>,
      icon: BarChart3,
    }
  ];

  const seoDevProcessSteps: ProcessStep[] = [
    {
      id: 'seo-audit',
      stepNumber: '01',
      title: 'Full Website Audit & Research',
      description: 'We perform deep keyword research and a comprehensive audit to pinpoint exactly where your site can dominate search results.',
      icon: Search,
      imageUrl: 'Discovery_Strategy.jpeg',
      bullets: ['In-Depth Keyword Goldmining', 'Full Technical SEO Auditing', 'Comprehensive Competitor Analysis'],
    ...
    },
    {
      id: 'seo-strategy',
      stepNumber: '02',
      title: 'Strategic SEO Blueprint',
      description: 'We outline an aggressive roadmap containing high-converting keyword targeting guidelines and standard editorial calendars.',
      icon: Compass,
      imageUrl: '/src/assets/images/Prototyping.jpeg',
      bullets: ['High-Intent Keyword Blueprints', 'Technical Optimization roadmaps', 'Full Content Editorial Calendars'],
    ...
    },
    {
      id: 'seo-optimization',
      stepNumber: '03',
      title: 'On-Page & Core Web Vitals',
      description: 'We implement technical adjustments, enhance load speeds, and draft high-performance keyword-targeted landing pages.',
      icon: Zap,
      imageUrl: '/src/assets/images/web-development.jpeg',
      bullets: ['Meta-Tag & Structured Schema tuning', 'Page Loading Speed Adjustments', 'Quality Keyword Content Placement'],
    ...
    },
    {
      id: 'seo-authority',
      stepNumber: '04',
      title: 'Authority & Link Amplification',
      description: 'We execute white-hat link acquisition and citation cleanup campaigns to drive search credibility and domain authority.',
      icon: Award,
      imageUrl: '/src/assets/images/webdev-launch.jpeg',
      bullets: ['Organic Authority Link Outreach', 'Digital PR Placements', 'Local Directory Cleanup'],
    ...
    },
    {
      id: 'seo-monitoring',
      stepNumber: '05',
      title: 'Continuous Growth Analytics',
      description: 'We track domain authority progression, provide transparent monthly reports, and continually adjust variables for top rankings.',
      icon: LifeBuoy,
      imageUrl: '/src/assets/images/nexora-empire-tech-team-collaboration.png',
      bullets: ['Comprehensive Monthly Analytics Reports', 'Search Console Auditing', 'Dynamic Strategy Re-alignment'],
  ...
  const faqs = [
    {
      ...
      a: 'SEO is a long-term investment. Most businesses begin seeing meaningful improvements within 3–6 months.'
    },
    {
      q: 'Can you guarantee first-page rankings?',
      a: 'No ethical agency can guarantee rankings, but we follow proven strategies that maximize your chances of long-term success.'
    },
    {
      q: 'Do you work with local businesses?',
      a: 'Yes. We help businesses improve their visibility in local search results and Google Maps.'
    },
    {
      q: 'Will I receive monthly reports?',
      a: 'Absolutely. You\'ll receive detailed reports covering rankings, traffic, conversions, and campaign performance.'
    },
    {
      q: 'Can you optimize my existing website?',
      a: 'Yes. We improve existing websites without requiring a complete redesign.'
    },
    {
      q: 'Do you also manage Google Ads?',
      a: 'Yes. We can combine SEO with paid advertising to accelerate your digital growth.'
    }
  ];

  // Dummy data for the interactive SEO dashboard
  const rankingQueries = [
    { query: 'best luxury agency', start: '#48', current: '#1', change: '+47', status: 'up' },
    { query: 'AI software solutions', start: '#12', current: '#2', change: '+10', status: 'up' },
    { query: 'creative design experts', start: '#8', current: '#1', change: '+7', status: 'up' },
    { query: 'enterprise tech consulting', start: '#35', current: '#4', change: '+31', status: 'up' },
  ];

  return (
    <div className="relative w-full bg-[#030308] text-slate-100 overflow-hidden" id="seo-page-root">
      
      {/* Background radial accent glows */}
      <div className="absolute top-[8%] left-[-10%] w-[500px] h-[500px] bg-brand-electric/10 rounded-full filter blur-[120px] pointer-events-none" />
      <div className="absolute top-[35%] right-[-10%] w-[600px] h-[600px] bg-brand-violet/10 rounded-full filter blur-[150px] pointer-events-none" />
      ...
      {/* Hero Section (Dark) */}
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 px-6 md:px-12 border-b border-indigo-950/40 bg-[#020205]/40" id="seo-hero">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-black text-white leading-none tracking-tight">
                Grow Your Business Where Customers <br className="hidden sm:inline" />
              ...
              <p className="font-sans text-base sm:text-lg text-slate-400 leading-relaxed max-w-2xl">
                We help businesses increase their online visibility, rank higher on search engines, attract qualified traffic, and convert visitors into loyal customers through data-driven SEO and digital growth strategies.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button
                  onClick={() => {
                    window.open('https://wa.me/237677079559?text=Hello%20Nexora%20Empire!%20I%20would%20like%20to%20start%20an%20SEO%20and%20growth%20project%20with%20you.%20I%20am%20interested%20in%20your%20digital%20solutions.', '_blank');
                  }}
                ...
                <button
                  ...
                  className="flex items-center justify-center px-8 py-4 rounded-2xl bg-[#080815]/60 border border-brand-electric/25 text-white font-sans text-sm font-semibold hover:border-brand-electric hover:bg-brand-electric/5 transition-all cursor-pointer"
                >
                  View Case Studies
                </button>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8 border-t border-indigo-950/20 max-w-xl">
                <div>
                  <div className="font-display text-2xl sm:text-3xl font-black text-white"><AnimatedCounter value="94%+" /></div>
                  <div className="font-mono text-[10px] tracking-wider text-slate-500 uppercase">Traffic Growth</div>
                </div>
                <div>
                  <div className="font-display text-2xl sm:text-3xl font-black text-white"><AnimatedCounter value="100%" /></div>
                  <div className="font-mono text-[10px] tracking-wider text-slate-500 uppercase">White-hat SEO</div>
                </div>
                <div>
                  <div className="font-display text-2xl sm:text-3xl font-black text-white"><AnimatedCounter value="24/7" /></div>
                  <div className="font-mono text-[10px] tracking-wider text-slate-500 uppercase">Rank Monitoring</div>
                </div>
              </div>
            </div>
      ...
      {/* What We Do (Light) */}
      <section className="relative py-28 sm:py-36 bg-[#fafbfc] border-t border-b border-slate-200/50 overflow-hidden" id="seo-services-section">
        ...
        <div className="absolute left-0 top-[20%] w-[350px] h-[350px] pointer-events-none opacity-80 hidden md:block">
          <div className="absolute top-[40%] left-12 w-4.5 h-4.5 rounded-full bg-brand-electric shadow-[0_0_18px_rgba(47,91,255,0.45)] z-10" />
          <div className="absolute top-[40%] left-12 -translate-x-1/2 -translate-y-1/2 w-[160px] h-[160px] rounded-full border border-brand-electric/20" />
          <div className="absolute top-[40%] left-12 -translate-x-1/2 -translate-y-1/2 w-[320px] h-[320px] rounded-full border border-brand-electric/15" />
        </div>
        ...
        <div className="absolute right-0 top-[25%] w-[350px] h-[350px] pointer-events-none opacity-80 hidden md:block">
          <div className="absolute top-[30%] right-16 w-4.5 h-4.5 rounded-full bg-brand-electric shadow-[0_0_18px_rgba(47,91,255,0.45)] z-10" />
          ...
          <div className="absolute top-[30%] right-16 -translate-x-1/2 -translate-y-1/2 w-[240px] h-[240px] rounded-full border border-brand-electric/15" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 font-sans">
          ...
          <div className="w-full mb-20 flex flex-col items-center text-center max-w-3xl mx-auto">
            <motion.div 
              ...
              className="inline-flex items-center gap-2.5 px-4.5 py-1.5 rounded-full bg-brand-electric/5 border border-brand-electric/20 mb-6 select-none shadow-[0_2px_10px_rgba(47,91,255,0.03)]"
              id="seo-services-badge"
            >
              <span className="w-2.5 h-2.5 rounded-full bg-brand-electric" />
              <span className="font-mono text-xs tracking-[0.18em] font-extrabold text-brand-electric">
                WHAT WE DO
              </span>
            </motion.div>
            ...
            >
              SEO Strategies That Drive<br className="hidden sm:inline" /> Real <span className="bg-[linear-gradient(90deg,#2F5BFF_0%,#4A47FF_35%,#6A38F8_70%,#8B1DCA_100%)] bg-clip-text text-transparent">Business Growth</span>
            </motion.h2>
            ...
            <motion.p 
              ...
              id="seo-services-desc"
            >
              From technical optimization to content strategy, we help your business get discovered by the right audience and generate measurable results.
            </motion.p>
          </div>

          {/* Grid of SEO services */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="seo-services-grid">
            {seoServices.map((service, index) => {
              ...
              return (
                <motion.div 
                  ...
                  className="bg-white rounded-[24px] border border-slate-100/90 p-8 flex flex-col h-full justify-between transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_24px_50px_rgba(47,91,255,0.05)] hover:border-brand-electric/25 group cursor-pointer text-left"
                  id={service.id}
                >
                  <div>
                    {/* Icon Box */}
                    <div className="w-14 h-14 rounded-2xl bg-brand-electric/10 flex items-center justify-center mb-6 transition-all group-hover:bg-brand-electric/15">
                      <Icon className="w-7 h-7 text-brand-electric" strokeWidth={1.5} />
                    </div>
                  ...
                  {/* Learn More link */}
                  <div className="inline-flex items-center gap-2 text-brand-electric hover:text-brand-violet font-semibold text-sm select-none group/btn transition-colors duration-200">
                    <span>Learn More</span>
                    <div className="w-5 h-5 rounded-full border border-brand-electric flex items-center justify-center transition-transform duration-300 group-hover/btn:translate-x-1.5">
                      <ChevronRight className="w-3 h-3 text-brand-electric" />
                    </div>
                  </div>
                </motion.div>
              );
      ...
      <OurProvenProcess 
        idPrefix="seo-process"
        badgeText="OUR SEO PROCESS"
        titleText="A Data-Driven Strategy for Sustainable Growth"
        steps={seoDevProcessSteps}
      />

      {/* Pricing Packages (Light) */}
      <section className="relative py-28 sm:py-36 bg-[#fafbfc] border-t border-b border-slate-200/50 overflow-hidden" id="seo-pricing-section">
        ...
        <div className="absolute left-0 top-[20%] w-[350px] h-[350px] pointer-events-none opacity-80 hidden md:block">
          <div className="absolute top-[40%] left-12 w-4.5 h-4.5 rounded-full bg-brand-electric shadow-[0_0_18px_rgba(47,91,255,0.45)] z-10" />
          <div className="absolute top-[40%] left-12 -translate-x-1/2 -translate-y-1/2 w-[160px] h-[160px] rounded-full border border-brand-electric/25" />
          <div className="absolute top-[40%] left-12 -translate-x-1/2 -translate-y-1/2 w-[320px] h-[320px] rounded-full border border-brand-electric/15" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 font-sans text-center">
          ...
          <div className="w-full mb-16 flex flex-col items-center text-center max-w-3xl mx-auto">
            <motion.div 
              ...
              transition={{ duration: 0.5 }}
              className="inline-flex items-center gap-2.5 px-4.5 py-1.5 rounded-full bg-brand-electric/5 border border-brand-electric/20 mb-6 select-none shadow-[0_2px_10px_rgba(47,91,255,0.03)]"
              id="seo-pricing-badge"
            >
              <span className="w-2.5 h-2.5 rounded-full bg-brand-electric" />
              <span className="font-mono text-xs tracking-[0.18em] font-extrabold text-brand-electric uppercase">
                PRICING PACKAGES
              </span>
            </motion.div>
            ...
            <motion.p 
              ...
              id="seo-pricing-desc"
            >
              Choose the perfect plan for your SEO and growth needs.
            </motion.p>
          ...
          {/* Pricing cards grid */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch mb-12 animate-fade-in" id="seo-pricing-grid">
            ...
            >
              ...
              <div>
                ...
                {/* Description */}
                <p className="text-blue-100 text-sm font-sans mb-6 leading-relaxed">
                ...
                <div className="mb-6">
                  ...
                  <span className="text-blue-100/80 text-xs font-sans block mt-1 font-medium">
                    Per month
                  </span>
                </div>
          ...
          <motion.div
            ...
            id="seo-pricing-custom-bar"
          >
            <div className="flex items-center gap-3.5 text-left">
              <div className="w-11 h-11 rounded-xl bg-brand-electric/10 flex items-center justify-center text-brand-electric">
                <MessageSquare className="w-5 h-5 text-brand-electric" />
              </div>
              <p className="font-sans text-base text-slate-700 font-medium">
                Want a custom audit of your website? Let's check your rankings.
              </p>
            </div>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 text-brand-electric hover:text-brand-violet font-semibold text-sm group cursor-pointer shrink-0 transition-all duration-200"
            >
        ...
        <div className="container mx-auto max-w-5xl px-6 relative z-10">
          ...
          <div className="text-center mb-16 md:mb-20">
            ...
            >
              ...
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-display font-extrabold tracking-tight text-white mt-3">
                SEO & Growth <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-brand-violet bg-clip-text text-transparent">FAQ</span>
              </h2>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
              ...
              <button
                onClick={() => {
                  const msg = encodeURIComponent("Hi, I have some questions about your SEO & Growth services.");
      ...
      {/* Final CTA (Dark) */}
      <section className="relative py-20 bg-[#020205] text-white text-center overflow-hidden border-t border-indigo-950/25" id="seo-cta">
        <div className="max-w-4xl mx-auto px-6 space-y-8 relative z-10">
          <span className="font-mono text-[10px] tracking-[0.25em] font-bold text-brand-electric uppercase">
            Let's Shape Your Growth Strategy
          </span>
          ...
          <p className="font-sans text-sm sm:text-base text-slate-400 max-w-xl mx-auto leading-relaxed">
            Let's help your business rank higher, attract more customers, and generate sustainable long-term growth.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
            <button
              ...
              className="flex items-center justify-center px-8 py-4 rounded-2xl bg-[linear-gradient(90deg,#2F5BFF_0%,#4A47FF_35%,#6A38F8_70%,#8B1DCA_100%)] text-white font-sans text-sm font-semibold hover:brightness-110 hover:shadow-[0_0_25px_rgba(106,56,248,0.3)] transition-all cursor-pointer w-full sm:w-auto"
            >
              Start Your Project
              <ArrowRight className="w-4 h-4 ml-2" />
            </button>
            <button
              ...
              className="flex items-center justify-center px-8 py-4 rounded-2xl bg-[#080815]/60 border border-brand-electric/25 text-white font-sans text-sm font-semibold hover:border-brand-electric hover:bg-brand-electric/5 transition-all cursor-pointer w-full sm:w-auto"
            >
              Contact Us
            </button>
          </div>
