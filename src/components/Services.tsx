  ...
  const services: ServiceItem[] = [
    {
      ...
      description: <span>Professional <span className="font-semibold text-white">web design and development services</span>. We build <span className="font-semibold text-white">responsive business websites</span>, custom <span className="font-semibold text-white">e-commerce storefronts</span>, and optimized corporate sites that convert.</span>,
      icon: Globe,
    ...
    },
    {
      ...
      description: <span>High-performance <span className="font-semibold text-white">mobile app development services</span>. We engineer native iOS, Android, and <span className="font-semibold text-white">cross-platform mobile applications</span> tailored to scale.</span>,
      icon: Smartphone,
    ...
    },
    {
      ...
      description: <span>High-impact logos, <span className="font-semibold text-white">brand identities</span>, and custom visual design systems that help brands stand out and establish <span className="font-semibold text-white">global credibility</span>.</span>,
      icon: Palette,
    ...
    },
    {
      ...
      number: '04',
      title: 'AI Solutions',
      description: <span>Custom <span className="font-semibold text-white">AI solutions</span>, automated workflows, intelligent bots, and smart <span className="font-semibold text-white">software integrations</span> designed to improve operational efficiency.</span>,
      icon: Sparkles,
