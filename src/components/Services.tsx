  ...
  const services: ServiceItem[] = [
    {
      ...
      description: <span>Professional web design and development services. We build responsive business websites, custom e-commerce storefronts, and optimized corporate sites that convert.</span>,
      icon: Globe,
    ...
    },
    {
      ...
      description: <span>High-performance mobile app development services. We engineer native iOS, Android, and cross-platform mobile applications tailored to scale.</span>,
      icon: Smartphone,
    ...
    },
    {
      ...
      description: <span>High-impact logos, brand identities, and custom visual design systems that help brands stand out and establish global credibility.</span>,
      icon: Palette,
    ...
    },
    {
      ...
      number: '04',
      title: 'AI Solutions',
      description: <span>Custom AI solutions, automated workflows, intelligent bots, and smart software integrations designed to improve business operational efficiency.</span>,
      icon: Sparkles,
