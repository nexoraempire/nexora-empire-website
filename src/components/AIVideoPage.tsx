...
export const AIVideoPage: React.FC<AIVideoPageProps> = ({ setView }) => {
  ...
  const videoProcessSteps: ProcessStep[] = [
    ...
    },
    {
      ...
      icon: Scissors,
      imageUrl: '/assets/images/ai_video_hero_1782584633591.webp',
    ...
    },
    {
      ...
      icon: Play,
      imageUrl: '/assets/images/work_marcus_1782241723295.jpg',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-black text-white leading-none tracking-tight">
                AI Video <br className="hidden sm:inline" />
              ...
              <p className="font-sans text-base sm:text-lg text-slate-400 leading-relaxed max-w-2xl">
                Nexora Empire provides professional AI video creation services. From our base in Buea, we build marketing videos, product ads, and generative visual assets to help companies scale.
              </p>
