...
export const EducationPage: React.FC<EducationPageProps> = ({ setView }) => {
  ...
  return (
    <div className="relative w-full bg-[#030308] text-slate-100 overflow-hidden" id="education-page-root">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 px-6 md:px-12 border-b border-indigo-950/40 bg-[#020205]/40" id="education-hero">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button
                  onClick={() => {
                    window.open('https://wa.me/237677079559?text=Hello%20Nexora%20Empire!%20I%20would%20like%20to%20discuss%20custom%20education%20software%20solutions%20for%2520my%20school.', '_blank');
                  }}
      ...
      <section className="relative py-28 sm:py-36 bg-[#fafbfc] border-t border-b border-slate-200/50 overflow-hidden" id="education-services-section">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 font-sans">
          ...
          <div className="w-full mb-20 flex flex-col items-center text-center max-w-3xl mx-auto">
            ...
            >
              Academic Tech <br className="hidden sm:inline" />
            ...
            >
              We design and construct interactive virtual classrooms, mobile learning applications, and student record software systems.
            </motion.p>
          </div>

          {/* Grid of services */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" id="education-services-grid">
            {[
              {
                id: 'lms',
                title: 'LMS Architectures',
                description: 'Custom course managers, video hosting systems, and visual timelines mapping syllabus progression.',
                icon: BookOpen
              },
              {
                id: 'virtual',
                title: 'Virtual Classrooms',
                description: 'Secure real-time audio/video links integrated directly with class calendars and student rosters.',
                icon: Video
              },
              {
                id: 'grading',
                title: 'Grading Engines',
                description: 'Interactive auto-graded questionnaire files and customizable digital certificates issuance pipelines.',
                icon: Award
              },
              {
                id: 'admission',
                title: 'Admissions Portals',
                description: 'Automated student registry systems, tuition payment channels, and school statistics trackers.',
                icon: Database
              }
            ].map((service, index) => {
      ...
      <section className="relative py-20 md:py-28 bg-[#020205] border-b border-indigo-950/20" id="education-dna-section">
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <span className="font-sans text-xs sm:text-sm text-slate-350">Custom LMS Dashboard Portals</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                  <span className="font-sans text-xs sm:text-sm text-slate-355">Interactive Quiz Engines</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                  <span className="font-sans text-xs sm:text-sm text-slate-355">Unified Student Grade Ledgers</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                  <span className="font-sans text-xs sm:text-sm text-slate-355">Automated Performance Reports</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative w-full h-[320px] sm:h-[420px] rounded-3xl overflow-hidden shadow-2xl border border-indigo-950/40 bg-zinc-950/30">
              <div className="absolute inset-0 bg-cover bg-center filter brightness-[0.7] contrast-[1.05]" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=800&auto=format&fit=crop')" }} />
              ...
              <div className="absolute bottom-6 left-6 z-10 flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 flex items-center justify-center text-white">
                  <BookOpen className="w-5 h-5 animate-pulse text-indigo-400" />
                </div>
      ...
      {/* FAQ Section */}
      <section className="relative py-20 bg-[#030308]/40 overflow-hidden border-t border-indigo-950/25" id="education-faq">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
              ...
              <button
                onClick={() => {
                  const msg = encodeURIComponent("Hi, I have some questions about your Education Software Solutions.");
      ...
      {/* Call to Action */}
      <section className="relative py-20 bg-[#020205] text-white text-center overflow-hidden border-t border-indigo-950/25" id="education-cta">
        <div className="max-w-4xl mx-auto px-6 space-y-8 relative z-10">
          ...
          <h3 className="font-display text-3xl sm:text-4xl lg:text-5xl font-black leading-tight tracking-tight text-white">
            ...
            E-Learning <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-brand-violet bg-clip-text text-transparent">Digital Asset?</span>
          </h3>
