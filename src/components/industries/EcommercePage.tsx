...
export const EcommercePage: React.FC<EcommercePageProps> = ({ setView }) => {
  ...
  return (
    <div className="relative w-full bg-[#030308] text-slate-100 overflow-hidden" id="ecommerce-page-root">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 px-6 md:px-12 border-b border-indigo-950/40 bg-[#020205]/40" id="ecommerce-hero">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button
                  onClick={() => {
                    window.open('https://wa.me/237677079559?text=Hello%20Nexora%20Empire!%20I%20would%20like%20to%20discuss%20custom%20e-commerce%20software%20solutions%20for%2520my%20business.', '_blank');
                  }}
      ...
      <section className="relative py-28 sm:py-36 bg-[#fafbfc] border-t border-b border-slate-200/50 overflow-hidden" id="ecommerce-services-section">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 font-sans">
          ...
          <div className="w-full mb-20 flex flex-col items-center text-center max-w-3xl mx-auto">
            ...
            >
              E-commerce Tech <br className="hidden sm:inline" />
            ...
            >
              We design and construct fast, customized storefronts, secure multi-channel order frameworks, and automated shipping calculators.
            </motion.p>
          </div>

          {/* Grid of services */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" id="ecommerce-services-grid">
            {[
              {
                id: 'storefront',
                title: 'Custom Storefronts',
                description: 'Superfast Next.js store catalogs, interactive sizing helpers, and lightning quick product search filters.',
                icon: Tag
              },
              {
                id: 'marketplace',
                title: 'Marketplaces',
                description: 'Multi-vendor platform management tools, vendor sales ledgers, and centralized catalog approval pipelines.',
                icon: Layers
              },
              {
                id: 'shipping',
                title: 'Shipping Hubs',
                description: 'Courier API integrations, live tracking status updates, and automated parcel delivery updates.',
                icon: Truck
              },
              {
                id: 'inventory',
                title: 'Inventory Sync',
                description: 'Direct stock tracking bridges linked with corporate ERPs and retail accounting frameworks.',
                icon: Database
              }
            ].map((service, index) => {
      ...
      <section className="relative py-20 md:py-28 bg-[#020205] border-b border-indigo-950/20" id="ecommerce-dna-section">
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5 order-2 lg:order-1 relative w-full h-[320px] sm:h-[420px] rounded-3xl overflow-hidden shadow-2xl border border-indigo-950/40 bg-zinc-950/30">
              <div className="absolute inset-0 bg-cover bg-center filter brightness-[0.7] contrast-[1.05]" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=800&auto=format&fit=crop')" }} />
            ...
            <div className="lg:col-span-7 order-1 lg:order-2 space-y-6 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <span className="font-sans text-xs sm:text-sm text-slate-355">Custom B2B & B2C Ordering</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                  <span className="font-sans text-xs sm:text-sm text-slate-355">Multi-Channel Cart Synchronization</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                  <span className="font-sans text-xs sm:text-sm text-slate-355">Seamless Local & Global Payouts</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                  <span className="font-sans text-xs sm:text-sm text-slate-355">Detailed Accounting Integrations</span>
                </div>
              </div>
            </div>
      ...
      {/* FAQ Section */}
      <section className="relative py-20 bg-[#030308]/40 overflow-hidden border-t border-indigo-950/25" id="ecommerce-faq">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
              ...
              <button
                onClick={() => {
                  const msg = encodeURIComponent("Hi, I have some questions about your Ecommerce Software Solutions.");
      ...
      {/* Call to Action */}
      <section className="relative py-20 bg-[#020205] text-white text-center overflow-hidden border-t border-indigo-950/25" id="ecommerce-cta">
        <div className="max-w-4xl mx-auto px-6 space-y-8 relative z-10">
          ...
          <h3 className="font-display text-3xl sm:text-4xl lg:text-5xl font-black leading-tight tracking-tight text-white">
            ...
            E-commerce <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-brand-violet bg-clip-text text-transparent">Digital Asset?</span>
          </h3>
