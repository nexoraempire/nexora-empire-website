    ...
    <div className="relative w-full bg-white text-slate-900 overflow-hidden min-h-screen" id="enterprise-page-root">
      ...
      <div className="relative w-full overflow-hidden border-b border-slate-900/10 bg-[#060814]" id="enterprise-hero-wrapper">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 pt-32 pb-20 md:pt-40 md:pb-28 z-10 text-left">
          ...
          <button 
            onClick={() => window.open('https://wa.me/237677079559?text=Hello%20Nexora%20Empire!%20I%20would%20like%20to%20discuss%20custom%20enterprise%20software%20development%20for%20my%20company.', '_blank')}
      ...
      {/* FAQ Section */}
      <section className="relative py-20 md:py-28 border-t border-slate-100 bg-[#fafbfc]/30" id="enterprise-faq-section">
      ...
      {/* CTA */}
      <section className="relative py-20 md:py-28 border-t border-slate-100 bg-[#fafbfc]/40 text-center" id="enterprise-cta-section">
        <div className="max-w-4xl mx-auto px-6">
