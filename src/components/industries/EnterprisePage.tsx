...
export const EnterprisePage: React.FC<EnterprisePageProps> = ({ setView }) => {
  ...
  return (
    <div className="relative w-full bg-[#030308] text-slate-100 overflow-hidden" id="enterprise-page-root">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 px-6 md:px-12 border-b border-indigo-950/40 bg-[#020205]/40" id="enterprise-hero">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button
                  onClick={() => {
                    window.open('https://wa.me/237677079559?text=Hello%20Nexora%20Empire!%20I%20would%20like%20to%20discuss%20custom%20enterprise%20software%2520development%20for%2520my%2520company.', '_blank');
                  }}
      ...
      <section className="relative py-28 sm:py-36 bg-[#fafbfc] border-t border-b border-slate-200/50 overflow-hidden" id="enterprise-services-section">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 font-sans">
          ...
          <div className="w-full mb-20 flex flex-col items-center text-center max-w-3xl mx-auto">
            ...
            >
              We engineer custom enterprise software, business software solutions, and automated enterprise platforms tailored to your corporate workflows.
            </motion.p>
          </div>

          {/* Grid of services */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" id="enterprise-services-grid">
            {[
              {
                id: 'erp',
                title: 'Custom ERPs',
                description: 'Central systems to monitor supply lines, track active task times, and manage invoice sheets.',
                icon: Database
              },
              {
                id: 'crm',
                title: 'Custom CRM Platforms',
                description: 'Sales channel trackers, customer retention metrics, and customized messaging modules.',
                icon: Users
              },
              {
                id: 'workflow',
                title: 'Workflow Automations',
                description: 'Automated document parsing pipelines, task allocation triggers, and email sync scripts.',
                icon: Settings
              },
              {
                id: 'middleware',
                title: 'Integration Middleware',
                description: 'Secure web api layers connecting legacy databases with cloud nodes and billing systems.',
                icon: Server
              }
            ].map((service, index) => {
      ...
      <section className="relative py-20 md:py-28 bg-[#020205] border-b border-indigo-950/20" id="enterprise-dna-section">
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <span className="font-sans text-xs sm:text-sm text-slate-350">Custom CRM & ERP Modules</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                  <span className="font-sans text-xs sm:text-sm text-slate-350">Integrated Active Directory Authentication</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                  <span className="font-sans text-xs sm:text-sm text-slate-350">Centralized Cloud Storage & Security</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                  <span className="font-sans text-xs sm:text-sm text-slate-350">Automated Audit & Compliance Trails</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative w-full h-[320px] sm:h-[420px] rounded-3xl overflow-hidden shadow-2xl border border-indigo-950/40 bg-zinc-950/30">
              <div className="absolute inset-0 bg-cover bg-center filter brightness-[0.7] contrast-[1.05]" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=800&auto=format&fit=crop')" }} />
      ...
      {/* FAQ Section */}
      <section className="relative py-20 bg-[#030308]/40 overflow-hidden border-t border-indigo-950/25" id="enterprise-faq">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
              ...
              <button
                onClick={() => {
                  const msg = encodeURIComponent("Hi, I have some questions about your Enterprise Software Solutions.");
      ...
      {/* Call to Action */}
      <section className="relative py-20 bg-[#020205] text-white text-center overflow-hidden border-t border-indigo-950/25" id="enterprise-cta">
        <div className="max-w-4xl mx-auto px-6 space-y-8 relative z-10">
          ...
          <h3 className="font-display text-3xl sm:text-4xl lg:text-5xl font-black leading-tight tracking-tight text-white">
            ...
            Enterprise <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-brand-violet bg-clip-text text-transparent">Digital Asset?</span>
          </h3>
