...
export const FintechPage: React.FC<FintechPageProps> = ({ setView }) => {
  ...
  return (
    <div className="relative w-full bg-white text-slate-900 overflow-hidden min-h-screen" id="fintech-page-root">
      ...
      {/* Hero Wrapper */}
      <div className="relative w-full overflow-hidden border-b border-slate-900/10 bg-[#060814]" id="fintech-hero-wrapper">
        <div 
      ...
      {/* Row 1: Left/Right Narrative (Fintech: Image Left, Content Right) */}
      <section className="relative py-20 md:py-28 border-t border-slate-100 bg-[#fafbfc]/30" id="fintech-dna-section">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5 order-2 lg:order-1 relative w-full h-[320px] sm:h-[420px] rounded-3xl overflow-hidden shadow-2xl border border-slate-200/80 bg-slate-50">
              <div className="absolute inset-0 bg-cover bg-center filter brightness-[0.95] contrast-[1.05]" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1559526324-4b87b5e36e44?q=80&w=800&auto=format&fit=crop')" }} />
            ...
            <div className="lg:col-span-7 order-1 lg:order-2 space-y-6 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <span className="font-sans text-xs sm:text-sm text-slate-600">PCI-DSS Compliant Encryption</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-indigo-600 shrink-0 mt-0.5" />
                  <span className="font-sans text-xs sm:text-sm text-slate-600">Instant Mobile Money Integrations</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-indigo-600 shrink-0 mt-0.5" />
                  <span className="font-sans text-xs sm:text-sm text-slate-600">Real-time Transaction Auditing</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-indigo-600 shrink-0 mt-0.5" />
                  <span className="font-sans text-xs sm:text-sm text-slate-600">Automated Accounting Pipelines</span>
                </div>
              </div>
            </div>
      ...
      {/* What We Build Cards */}
      <section className="relative py-20 md:py-28 border-t border-slate-100 bg-[#fafbfc]/30" id="fintech-cards-section">
