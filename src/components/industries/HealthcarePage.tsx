...
export const HealthcarePage: React.FC<HealthcarePageProps> = ({ setView }) => {
  ...
  return (
    <div className="relative w-full bg-white text-slate-900 overflow-hidden min-h-screen" id="healthcare-page-root">
      ...
      {/* FAQ Section */}
      <section className="relative py-20 md:py-28 border-t border-slate-100 bg-[#fafbfc]/30" id="healthcare-faq-section">
      ...
      {/* CTA */}
      <section className="relative py-20 md:py-28 border-t border-slate-100 bg-[#fafbfc]/40 text-center" id="healthcare-cta-section">
        <div className="max-w-4xl mx-auto px-6">
