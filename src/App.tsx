...
const TrainingInternshipPage = React.lazy(() => import('./components/TrainingInternshipPage').then(m => ({ default: m.TrainingInternshipPage })));
const ContactPage = React.lazy(() => import('./components/ContactPage').then(m => ({ default: m.ContactPage })));
const WebDevPage = React.lazy(() => import('./components/WebDevPage').then(m => ({ default: m.WebDevPage })));
const MobileDevPage = React.lazy(() => import('./components/MobileDevPage').then(m => ({ default: m.MobileDevPage })));
const BrandingDesignPage = React.lazy(() => import('./components/BrandingDesignPage').then(m => ({ default: m.BrandingDesignPage })));
const SEOGrowthPage = React.lazy(() => import('./components/SEOGrowthPage').then(m => ({ default: m.SEOGrowthPage })));
const AIVideoPage = React.lazy(() => import('./components/AIVideoPage').then(m => ({ default: m.AIVideoPage })));
const SocialMediaManagementPage = React.lazy(() => import('./components/SocialMediaManagementPage').then(m => ({ default: m.SocialMediaManagementPage })));
